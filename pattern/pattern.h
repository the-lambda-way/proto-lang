...
// Copyable:    Copy semantics are simplier to reason about and more flexible.
// Polymorphic: Will be used by many different constructs. A single point of entry is preferred.
// Recursive:   Parser combination.

// These requiremens call for algebraic data types over OOP polymorphism.
