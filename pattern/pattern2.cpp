...
// lit
// -------------------------
lit::lit (const char        value) : value(std::string(1, value)), size(1)               {}
lit::lit (const std::string value) : value(value),                 size(value.size())    {}

bool lit::operator() (const std::string source, int pos) {
    // fast checks
...
// // rep
// // -------------------------
// rep::rep (const Pattern& pattern)        : rep(pattern, 0, -1) {}
// rep::rep (const Pattern& pattern, int n) : rep(pattern, n, n)  {}

// rep::rep (const Pattern& pattern, int min, int max)
