...
// Data types
// ---------------------------------------------------------------------------------------------------------------------
Pattern::Pattern (PatternType type) : type(type) {}

void Pattern::construct_lit (std::string value, int size) {
    static_assert(type == PatternType::lit, "Pattern is not of type literal.");
}
